...
ak_rgns_sf <- read_sf(here("data/raw/shapefile_demo_data/ak_regions_simp.shp"))
```
...
pop_df <- read_csv(here("data/raw/shapefile_demo_data/alaska_population.csv"))
```
...
```{r}
rivers_3338_sf <- read_sf(here("data/raw/shapefile_demo_data/ak_rivers_simp.shp"))
```
